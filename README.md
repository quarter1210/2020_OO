...
## 使用案例與其循序圖和活動圖
## 使用案例1-大學生想要參加聖誕派對
### 現今的網路充斥著各式各樣的資訊，網路社會儼然成為了複雜的生態鏈。而在活動方面，各式各樣的平台販賣著各種不同的價格、不同的場次，在這樣複雜的環境下經常發生詐騙、業者黃牛、退票塞車等等情況，而FIESTA便是一個專為大學生打造的活動資訊籌備整合平台，不論電子票卷、票價、活動方、資訊甚至是參加結束後的數據蒐集都由Fiesta一手包辦，藉由這樣統整性的規劃不但簡化了以往複雜的支線，還能藉此達成一個良好的循環，打造出一個與以往都不同的活動產業。
## 循序圖1
![44](44.PNG "44")
## 活動圖1
![55](55.PNG "55")
