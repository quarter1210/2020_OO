...
## 使用案例與其循序圖和活動圖
## 使用案例1-想要參加活動
### 現今的網路充斥著各式各樣的資訊，網路社會儼然成為了複雜的生態鏈。而在活動方面，各式各樣的平台販賣著各種不同的價格、不同的場次，在這樣複雜的環境下經常發生詐騙、業者黃牛、退票塞車等等情況，而FIESTA便是一個專為大學生打造的活動資訊籌備整合平台，不論電子票卷、票價、活動方、資訊甚至是參加結束後的金流與數據蒐集都由Fiesta一手包辦，藉由這樣統整性的規劃不但簡化了以往複雜的支線，還能藉此達成一個良好的循環，打造出一個與以往都不同的活動產業。
## 循序圖1
![44](44.png "44")
## 活動圖1
![55](55.PNG "55")
## 使用案例2-大學生去夜店玩
### 在大學四年的生活中，多多少少都會有三五好友一起去夜店遊玩的機會，但是過去夜店的入場方式為：排隊>身份證確認>現場購票>入場。如今使用Fiesta這個專為大學生打造的平台，不但能獲得更便宜的售價，還能在家購買電子票卷，如此一來入場方式就變成：掃二維碼>身份確認>入場。不但減去了排隊時間，還能夠在家先看看夜店方今日的活動資訊與售價。過去，夜店傳統的紙本票據浪費成本還很費時，現場的動線也是非常的堵塞，如今在Fiesta的配合下，不僅讓所有流程簡化也能讓店家更方便去管理人流，一舉兩得。
## 循序圖2
![66](66.PNG "66")
## 活動圖2
![77](77.PNG "77")
## 使用案例3-大型主辦方舉辦大型音樂會
### 今天有一個活動主辦方打算使用Fiesta來舉辦一個大型活動，若是以過去傳統的方式，大致上為主辦方擬定活動企劃並且開始一間一間聯絡適合的廠商，過程還要開幾次會議，並且開始找尋可以配合的線上售票平台和實體票卷等等.....等等繁雜的手續為何不讓Fiesta一手包辦，在創建活動的時候推薦給你評價高、最符合你預算的廠商，讓你在前期籌備的過程能夠輕鬆的組織聯繫，而在活動數據都被fiesta完整保留下來後，還有後台功能可以供活動方使用，他協助主辦方計算售票資訊、抽獎活動、活動反饋，以數據化的方式告訴主辦方哪裡做得好或哪裡不好協助改善，讓主辦方下次能夠更加注意平常忽略掉的事情。
## 循序圖3
![88](88.PNG "88")
## 活動圖3
![99](99.PNG "99")
